<template>
	<div class="index1">
		...
		<nav class="nav">
			<div class="nav-btn nav-active">最新</div>
			<div class="nav-btn">心理科普</div>
			<div class="nav-btn">心理专题</div>
			<div class="nav-btn">心理频道</div>
			<div class="nav-btn">案例分析</div>
			<div class="nav-btn">案例音乐</div>
		</nav>
			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<!--最新-->
						<scroller class='scrollBox' :on-refresh="reType && refresh" :on-infinite="reType && infinite" ref="my_scroller" >
							...
							<ul class="nav-list" >
								<li v-for="(item, index) in items" @click="goPath(index)">
									...
									<img class="rt" src="../../../assets/img/init22.png" alt="" />
								</li>
							</ul>
						</scroller>
					</div>

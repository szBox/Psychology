<template>
	<div class="index1">
		...
		<nav class="nav">
			<div>
				<ul class="nav-ul">
					<li class="nav-btn  nav-active"> 最新</li>
					<li class="nav-btn">心理科普</li>
					<li class="nav-btn">心理专题</li>
					<li class="nav-btn">心理频道</li>
					<li class="nav-btn">案例分析</li>
					<li class="nav-btn">案例音乐</li>
				</ul>
			</div>
